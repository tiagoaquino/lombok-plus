...
public class HandleResolvers extends EclipseAnnotationHandler<Resolvers> {
    ...
    @Override
    public void handle(AnnotationValues<Resolvers> annotation, Annotation ast, EclipseNode annotationNode) {
    ...
    static MethodDeclaration createResolver(TypeDeclaration parent, boolean deprecate, EclipseNode fieldNode,
        ...
        // NameReference fieldNameRef = new SingleNameReference((new String(field.name)
        // + ".resolve()").toCharArray(), p);
